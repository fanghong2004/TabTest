...
// TabTestDoc.cpp: CTabTestDoc 类的实现
//
...
CTabTestDoc::CTabTestDoc() noexcept
{
	// TODO: 在此添加一次性构造代码
...
// 缩略图的支持
void CTabTestDoc::OnDrawThumbnail(CDC& dc, LPRECT lprcBounds)
{
	// 修改此代码以绘制文档数据
...
// 搜索处理程序的支持
void CTabTestDoc::InitializeSearchContent()
{
...
void CTabTestDoc::SetSearchContent(const CString& value)
{
	if (value.IsEmpty())
	{
